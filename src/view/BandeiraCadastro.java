 ...
 * @author Producao
 */
public class BandeiraCadastro extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroBandeira
     */
    public BandeiraCadastro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        bandeiraQuery = java.beans.Beans.isDesignTime() ? null : totcardPUEntityManager.createQuery("SELECT b FROM Bandeira b");
        bandeiraList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : bandeiraQuery.getResultList();
        ...
        jLabelTitulo.setText("Cadastro de Bandeira");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, bandeiraList, jTable1);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idbandeira}"));
        columnBinding.setColumnName("Idbandeira");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BandeiraCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BandeiraCadastro().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private java.util.List<model.Bandeira> bandeiraList;
    private javax.persistence.Query bandeiraQuery;
