 ...
 * @author Producao
 */
public class AdministradoraCadastro extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroBandeira
     */
    public AdministradoraCadastro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        administradoraQuery1 = java.beans.Beans.isDesignTime() ? null : totcardPUEntityManager.createQuery("SELECT a FROM Administradora a");
        administradoraList1 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : administradoraQuery1.getResultList();
        ...
        jLabelTitulo.setText("Cadastro de Administradora");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, administradoraList1, jTable2);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idadministradora}"));
        columnBinding.setColumnName("Código");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${descricao}"));
        columnBinding.setColumnName("Administradora");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jLabelTitulo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 782, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradoraCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministradoraCadastro().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private java.util.List<model.Administradora> administradoraList1;
    private javax.persistence.Query administradoraQuery1;
